    ...
    >
      ...
      <div className={`${styles["profile__decs"]}`}>
        <p className={`${styles["profile__text"]}`}>
          Name : <span>property</span>
        </p>
        <p className={`${styles["profile__text"]}`}>
          Address : <span>property</span>
        </p>
        <p className={`${styles["profile__text"]}`}>
          Email : <span>property</span>
        </p>
        <p className={`${styles["profile__text"]}`}>
          Description : <span>property</span>
        </p>
        <p className={`${styles["profile__text"]}`}>
          Phone Number : <span>property</span>
        </p>
        <p className={`${styles["profile__text"]}`}>
          Status : <span>property</span>
        </p>
      </div>
    </div>
  );
