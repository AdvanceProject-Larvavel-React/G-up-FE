  ...
  const processPayment = async () => {
    try {
      ...
      if (response.status === 200) {
        await axios.delete(
          `http://127.0.0.1:8000/api/cart/delete/destroy/${IdUser}`,
          {
            headers: {
              "Content-Type": "application/json",
            },
    ...
    <>
      ...
      <div className={styles.shoppingCheckout}>
        <div className={styles.summary}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.discountOptions}>
              <button
                className={`${styles.discountOption} ${
                  discountPercentage === 15 ? styles.active : ""
                }`}
              ...
              <button
                className={`${styles.discountOption} ${
                  discountPercentage === 20 ? styles.active : ""
                }`}
            ...
            <div className={styles.deliveryOptions}>
              <button
                className={`${styles.deliveryOption} ${
                  deliveryMethod === "Fast" ? styles.active : ""
                }`}
              ...
              <button
                className={`${styles.deliveryOption} ${
                  deliveryMethod === "Normal" ? styles.active : ""
                }`}
        ...
        <div className={styles.paymentOptions}>
          <button className={styles.paymentOption} onClick={processPayment}>
            MOMO PAY
          </button>
